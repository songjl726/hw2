...
{
  Product* book = new Book(this->categoryID(), prodName_, price_, qty_, isbn_, author_);
  return book;
}
...
{
  Product* clothing = new Clothing(this->categoryID(), prodName_, price_, qty_, size_, brand_);
  return clothing;
}
...
{
  Product* movie = new Movie(this->categoryID(), prodName_, price_, qty_, genre_, rating_);
  return movie;  
}
